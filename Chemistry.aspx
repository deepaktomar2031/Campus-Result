<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Chemistry.aspx.vb" Inherits="Chemistry" %>
...
<body>
    ...
    <section id="services" class="padding50">
        <div class="container">
            <div class="row">
                <h2 class="background double animated wow fadeInUp" data-wow-delay="0.2s"><span><strong>C</strong>hemistry Result</span></h2>
            </div>
            <!-- ./ end row -->
            <div class="row">
