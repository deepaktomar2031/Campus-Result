<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ComputerScience.aspx.vb" Inherits="ComputerScience" %>
...
<body>
    ...
    <section id="services" class="padding50">
        <div class="container">
            <div class="row">
                <h2 class="background double animated wow fadeInUp" data-wow-delay="0.2s"><span><strong>C</strong>omputer Science Result</span></h2>
            </div>
            <!-- ./ end row -->
            <div class="row">
				...
				<div class="container">
					<div class="row">
						<div class="col-md-3 col-sm-4 col-md-push-3 animated wow fadeInLeft" data-wow-delay="0.2s">
							<h3 class="fh5co-lead">Aboutboutt</h3>
							<ul>
