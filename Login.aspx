        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <div class="sc-inner">
                        <h4>
                        <li><a href="ComputerScienceLogin.aspx">Computer Science</a></li>
                            </h4>   
                    </div>
                </div>
                <!-- ./ end service box -->
                <div class="col-md-4">
                    ...
                    <div class="sc-inner">
                        <h4>
                        <li><a href="GeologyLogin.aspx">Geology</a></li>
                        </h4>
                     </div>
                </div>
                <!-- ./ end service box -->
                <div class="col-md-4">
                    ...
                    <div class="sc-inner">
                        <h4>
                        <li><a href="StatisticsLogin.aspx">Statistics</a></li>
                        </h4>
                    </div>
                </div>
                <!-- ./ end service box -->
            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <div class="sc-inner">
                        <h4>
                        <li><a href="MathematicsLogin.aspx">Mathematics</a></li>
                        </h4>
                    </div>
                </div>
                <!-- ./ end service box -->
                <div class="col-md-4">
                    ...
                    <div class="sc-inner">
                        <h4>
                        <li><a href="ChemistryLogin.aspx">Chemistry</a></li>
                        </h4>
                    </div>
                </div>
                <!-- ./ end service box -->
                <div class="col-md-4">
                    ...
                    <div class="sc-inner">
                        <h4>
                        <li><a href="PhysicsLogin.aspx">Physics</a></li>
                        </h4>
                    </div>
                </div>
                <!-- ./ end service box -->
