...
Partial Class Chemistry
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            cmd.CommandText = "select * from chemistry where Enrollment='" & Session("login_Eno").ToString & "'"
            SQLConnection.Open()
            ...
            cmd.Connection = SQLConnection
            cmd.CommandText = "SELECT column_name FROM information_schema.columns WHERE table_name='chemistry' ORDER BY ordinal_position"
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        Response.Cookies("Chemistry.aspx").Expires = Now
