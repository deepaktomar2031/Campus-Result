...
Partial Class ComputerScience
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            cmd.CommandText = "select * from mca where Enrollment='" & Session("login_Eno").ToString & "'"
            SQLConnection.Open()
            ...
            cmd.Connection = SQLConnection
            cmd.CommandText = "SELECT column_name FROM information_schema.columns WHERE table_name='mca' ORDER BY ordinal_position"
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        Response.Cookies("ComputerScience.aspx").Expires = Now
